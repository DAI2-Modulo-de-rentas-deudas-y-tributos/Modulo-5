...
class ConcurrencyTests {
    ...
    private Debt debt(String suffix){TaxpayerReference taxpayer=catalog.createTaxpayer(new ApiDtos.CreateTaxpayerRequest(TaxpayerType.CITIZEN,"CONC-"+suffix+"-"+UUID.randomUUID(),Long.toUnsignedString(UUID.randomUUID().getMostSignificantBits()),null,"Concurrente"));return debtFor(taxpayer.id,suffix);}
