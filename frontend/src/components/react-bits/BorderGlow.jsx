...
// React Bits, variante JS-CSS: https://reactbits.dev/r/BorderGlow-JS-CSS.json
// Copyright (c) 2026 David Haz. Licencia en LICENSE.md.
// Adaptaciones: cancelar el barrido al desmontar y respetar movimiento reducido.
...
function animateValue({ start = 0, end = 100, duration = 1000, delay = 0, ease = easeOutCubic, onUpdate, onEnd }) {
  ...
  const timerId = setTimeout(() => { frameId = requestAnimationFrame(tick); }, delay);
  return () => {
